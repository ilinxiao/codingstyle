...
为提高项目代码的可读性，减少协作的沟通成本，参考Google Python编码风格建议，制定了该编码规范。
本人的Python开发项目编码将遵循以下规范：
...
2. 模块的定义是任何以.py结尾的代码文件被看作是项目中的一个模块，它由函数和类组成。
   ...
   段文字就是模块文档说明。
3. 类的文档说明是必须的。
4. 这里的函数包括函数function(def写在class外面)、方法method(def写在class里面)、生成器。函数的文档说
...
6. 用自己熟悉的语言，英文或中文，写文档说明。多写关于对业务的理解和技术实现细节，一段
